...
sys.stdout.write("\x1b]2;B L A C K |EYE| D O W N E D\x07")
def modifications():
...
info = """
[\033[91mSIN\033[00m] \033[91mBlackEye, Made By Tokyo, Updated Design By NM00.
Re Coded from Tokyo,
i liked this scripts, so i simply re coded it,
i will be adding new methods all the time,
stay tuned. 
Tokyos Biggest Attack
180-200 gbps
BlackEye, Biggest Attack,
Not Recorded, (Most Likely The Same As Tokyo.)
"""
...
║ \033[00mExit                          \033[91m|\033[00m EXIT Tokyo \033[91m         ║
║ \033[00mMethods                       \033[91m|\033[00m CORT METHODS\033[91m         ║
║ \033[00mTools                         \033[91m|\033[00m BASIC TOOLS\033[91m          ║
║ \033[00mUpdates                       \033[91m|\033[00m DISPLAY UPDATE NOTES\033[91m ║
║ \033[00mInfo                          \033[91m|\033[00m DISPLAY TokyoS INFO\033[91m ║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
║ \033[00mStats                         \033[91m|\033[00m DISPLAY Tokyo STATS\033[91m║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
|  _ <| |/ _` |/ __| |/ /  __|| | | |/ _ \
| |_) | | (_| | (__|   <| |___| |_| |  __/
|____/|_|\__,_|\___|_|\_\______\__, |\___|
                                __/ |     
                               |___/      
                       \033[1;91m сука\033[00m
"""

altbanner = """
			     Angels go to heaven
			   Demons meet the gates of hell
		      Tokyo people are punished put in hell
		     Sinners Meet The mstokyo And Fall Into The Vortex
		      		       	B L A C K E Y E  
"""

cookie = open(".Tokyo_cookie","w+")
...
def main():
	...
	while True:
		sys.stdout.write("\x1b]2;B L A C K E Y E\x07")
		sin = input("\033[1;00m[\033[91mTokyo\033[1;00m]-\033[91mк\033[00m ").lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (altbanner)
			...
			sfound = 0
			sys.stdout.write("\x1b]2;B L A C K E Y E |{}| F O U N D\x07".format (sfound))
			try:
				host = sin.split(" ")[1]
				with open(r"/usr/share/Tokyo/subnames.txt", "r") as sub:
			...
			try:
				...
				while True:
					try:
						...
						sys.stdout.write("\x1b]2;B L A C K E Y E |{}ms| D E M O N S\x07".format (stop))
						print ("Tokyo: {}:{} | Time: {}ms [\033[91mUP\033[00m]".format(ip, port, stop))
						sock.close()
						time.sleep(1)
					except socket.error:
						sys.stdout.write("\x1b]2;B L A C K E Y E |TIME OUT| D E M O N S\x07")
						print ("Tokyo: {}:{} [\033[91mDOWN\033[00m]".format(ip, port))
						time.sleep(1)
					except KeyboardInterrupt:
						print("")
						main()
